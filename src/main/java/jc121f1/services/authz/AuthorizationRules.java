...
public final class AuthorizationRules {
    ...
    public boolean deletesOwner(ActionDescriptor action, ResourceReference resource, String ownerId) {
        return AuthAction.DELETE_USER.value().equals(action.value()) && resource.resourceId().equals(ownerId);
    }
}
